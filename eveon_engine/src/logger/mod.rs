...
impl LoggerUi {
    pub fn ui(&mut self, ui: &mut eglfw::Ui) {
        try_mut_log(|logs| {
        ...
        ui.horizontal(|ui| {
            ...
            ui.add(eglfw::widgets::DragValue::new(&mut self.max_log_length).speed(1));
        });
        ...
        ui.horizontal(|ui| {
            ...
            ui.with_layout(eglfw::Layout::right_to_left(eglfw::Align::Center), |ui| {
...
pub fn logger_ui(ui: &mut eglfw::Ui) {
